...
const services = [
  ...
  {
    num: '03',
    titleH: <>SOFTWARE<br />ENGINEER</>,
    titleVText: 'SOFTWARE ENGINEER',
    items: ['Architecture', 'Clean Code'],
    desc: 'Building scalable, maintainable systems with modern architecture patterns and engineering best practices.',
  },
  {
    num: '04',
